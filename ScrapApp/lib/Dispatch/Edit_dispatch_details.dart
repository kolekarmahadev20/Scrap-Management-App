...
//           String fileName, String? keyword, Uint8List? imageByte) async {
//         if (imageByte != null) {
//           // Ensure imageBytes is valid
...
//               content:
//                   Text("${jsonData['msg']} ${jsonData['liftedTaxAmount']}")));
//         } else {
...
//             otherImg =
//                 jsonData['ot'] != null ? '${Image_URL}${jsonData['ot']}' : "";
...
//         source: ImageSource.gallery); // Pick only one image
//
//     if (pickedFile != null) {
//       setState(() {
//         _images = [
//           File(pickedFile.path)
//         ]; // Replace the list with the new image
//       });
...
//         ]; // Replace the list with the new captured image
//       });
//       widget.onImagesSelected(_images);
//       _showSingleImageNotification();
//     }
...
//                                 index), // Delete the selected image
//                           ),
//                         ),
//                       ],
//                     );
