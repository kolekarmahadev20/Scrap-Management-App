...
class View_refund_details extends StatelessWidget {
  @override
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    buildExpansionTile(),
                    buildScrollableContainer("Payment Status", buildOrderListView),
                    buildScrollableContainer("EMD Status", buildPaymentListView),
                  ],
                ),
              ),
            ),
  ...
  Widget buildOrderListView() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return buildPaymentStatusListTile(context);
      },
    );
  }
  ...
  Widget buildPaymentListView() {
    return ListView.builder(
      itemCount: 5,
      itemBuilder: (context, index) {
        return buildEmdStatusListTile(context);
      },
    );
  }

  Widget buildPaymentStatusListTile(BuildContext context) {
    return Padding(
  ...
  Widget buildEmdStatusListTile(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.all(4.0),
      child: Card(
        elevation: 1,
